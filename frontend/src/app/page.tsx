        ...
        <div className="relative z-10 text-center max-w-3xl px-6 py-12">
          ...
          >
            {activePromos.length > 0 ? (
              ...
              <Link href="/shop" className="group relative inline-flex items-center gap-3 px-8 py-4 bg-amber-500 text-black font-extrabold uppercase tracking-[0.2em] text-[0.95rem] rounded-full overflow-hidden shadow-[0_0_50px_rgba(245,158,11,0.5)] hover:shadow-[0_0_70px_rgba(245,158,11,0.7)] transition-all">

        ...
        <div className="container relative z-10 px-6 mx-auto mt-12 lg:mt-24">
          <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_0.7fr] gap-12 lg:gap-20 items-center">
            ...
            <motion.div 
              ...
              className="text-left"
            >
              <div className="inline-flex items-center gap-3 bg-amber-500/10 backdrop-blur-xl border border-amber-500/40 rounded-full px-8 py-3 mb-10 lg:mb-12 shadow-[0_0_20px_rgba(201,168,76,0.15)]">
        ...
        <div className="relative z-10 text-center max-w-4xl px-6">
          ...
          >
            {activePromos.length > 0 ? (
              ...
              <Link href="/shop" className="group relative inline-flex items-center gap-4 px-20 py-7 bg-amber-500 text-black font-extrabold uppercase tracking-[0.2em] text-[0.95rem] rounded-full overflow-hidden shadow-[0_0_50px_rgba(245,158,11,0.5)] hover:shadow-[0_0_70px_rgba(245,158,11,0.7)] transition-all">
